...
public class SpreadsheetReader {
    ...
    public SpreadsheetReader(String path) {
        ...
        try {
            ...
            System.out.println("Workbook failed to open.");
            e.printStackTrace();
        }
    }
    ...
    public String getRandomCellFromColumn(String sheetName, String colNam, int rowCount, int rowStart) {
        ...
        return getCellData(sheetName, colNam, randomNumber);
    }
    ...
    public Map<String, Integer> getHeaderNameAndDataCount(int dataStartsAfterRow) {
        try {
            ...
            Map<String, Integer> colNameAndCount = new LinkedHashMap<>();
    ...
    public String getCellData(String sheetName, String colName, int rowNum) throws NullPointerException {
        try {
            ...
            int col_Num = -1;
            if (index == -1) {
                System.out.println("Workbook found, but sheet cannot be located, please check name");
    ...
    public boolean isSheetExist(String sheetName) {
        return workbook.getSheetIndex(sheetName) != -1 ||
                workbook.getSheetIndex(sheetName.toUpperCase()) != -1 ||
                workbook.getSheetIndex(sheetName.toLowerCase()) != -1;
    }
